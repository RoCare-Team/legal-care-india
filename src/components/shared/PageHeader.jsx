    ...
    >
      ...
      <Container className="relative z-10 py-5 sm:py-6">
        {breadcrumbs.length > 0 && (
          <nav aria-label="Breadcrumb" className="animate-fade-up mb-2.5">
            <ol className="flex flex-wrap items-center gap-1 text-[13px] text-slate-300/70">
        ...
        <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
          <div>
            {eyebrow && (
              <span
                className="animate-fade-up mb-2 inline-flex items-center gap-2 rounded-full border border-[#D4AF37]/25 bg-[#D4AF37]/10 px-3 py-0.5 text-[11px] font-medium uppercase tracking-wider text-[#D4AF37] backdrop-blur-sm"
            ...
            <h1
              className="animate-fade-up font-display text-[24px] font-extrabold leading-tight tracking-tight sm:text-[30px] lg:text-[34px]"
            ...
            {subtitle && (
              <p
                className="animate-fade-up mt-1.5 max-w-3xl text-[14px] leading-6 text-slate-300"
