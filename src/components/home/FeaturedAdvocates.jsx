  ...
  return (
    <Section className="bg-surface/55 pt-8 sm:pt-10 mt-10">
      <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-end">
        <Heading
          eyebrow="Featured"
          subtitle="Verified lawyers recently registered on Legal Care India."
        >
          Featured Lawyers
        </Heading>
        {advocates.length > 0 && (
      ...
      {advocates.length > 0 ? (
        ...
        <div className="mt-10 grid place-items-center rounded-2xl border border-dashed border-ink/15 bg-surface px-6 py-14 text-center">
          ...
          <h3 className="mt-4 font-semibold text-ink">Be the first lawyer to join</h3>
          <p className="mt-1 max-w-sm text-sm text-ink/55">
            No lawyers have registered yet. Create your profile and get discovered by clients
            across India.
          </p>
